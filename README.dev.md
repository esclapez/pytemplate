# `pytemplate` developer documentation
...
# install pytemplate as an editable package
...
The second is to use `tox`, which can be installed separately (e.g. with `pip install tox`), i.e. not necessarily inside the virtual environment you use for installing `pytemplate`, but then builds the necessary virtual environments itself by simply running:
...
cd $(mktemp -d pytemplate.XXXXXX)
git clone git@github.com:esclapez/pytemplate .
...
Visit
[https://test.pypi.org/project/pytemplate](https://test.pypi.org/project/pytemplate)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d pytemplate-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple pytemplate
```
...
Don't forget to also make a [release on GitHub](https://github.com/esclapez/pytemplate/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.